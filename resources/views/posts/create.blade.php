                ...
                <div class="col-12">
                    ...
                    <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-4 mx-auto">
                            ...
                            <div class="input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm">
                                <input type="file" name="cover" id="cover" value="{{ old('cover') }}"
                                    onchange="readURL(this);" class="form-control border-0" required>
                            </div>
                            <!-- Uploaded image area-->
                            <div class="image-area"><img id="imageResult" alt=""
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="engtitle"
                                class="form-control @error('engtitle') is-invalid @enderror" value="{{ old('engtitle') }}">
                            @error('engtitle')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="desc" id="desc" class="summernote" cols="30" rows="30"
                                class="my-editor form-control @error('desc') is-invalid @enderror">{{ old('desc') }}</textarea>
                            @error('desc')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="eng" id="eng" class="eng summernote" cols="30" rows="30"
                                class="my-editor form-control @error('eng') is-invalid @enderror">{{ old('eng') }}</textarea>
                            @error('eng')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
...
@push('scripts')
    ...
    {{--         placeholder: 'masukkan note disini!', --}}
    {{--         tabsize: 2, --}}
    {{--         height: 100 --}}
    {{--     }); --}}
    {{-- </script> --}}
