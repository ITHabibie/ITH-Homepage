...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="https://ith-dsti.unhas.ac.id/storage/images/logo/rfBbCHKyxJlrpS3kc3nER6EVyUiUxlAMne8tV16W.png" style="max-height: 55px">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link">CMS Powered by Laravel</a>
                                </li>
                            @endif
        ...
        <main class="py-4" style="background-color: ghostwhite">
            @yield('content')
        </main>
    </div>
