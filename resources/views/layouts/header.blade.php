<style>
    ...
    @media (min-width: 929px ) and (max-width:993px){
        ...
        .navbar-desktop .show, .navbar-desktop .collapsing {
            animation: none !important;
            display: flex !important;
            ...
            <div class="container d-flex justify-content-center justify-content-md-between">
                @isset($topbar)
                    ...
                    <div class="useful-links d-flex align-items-center">
                        ...
                        <nav style="padding-left:.3rem;">
                            <button type="button" aria-expanded="false" class="dropdown-toggle btn" data-bs-toggle="dropdown" style="color:white; font-size:12px;">{{$topbar->Layanan}}</button>
                            <div class="dropdown-menu">
                                <li class="nav-item"><a href="http://lppm-pm.ith.ac.id" class="dropdown-item">LPPM-PM ITH</a></li>
                                <li class="nav-item"><a href="http://od.ith.ac.id" class="dropdown-item">DOKUMEN TERBUKA</a></li>
                                <li class="nav-item"><a href="http://digilab.ith.ac.id" class="dropdown-item">DIGITAL LIBRARY ITH</a></li>
                                <li class="nav-item"><a href="http://simpel.ith.ac.id" class="dropdown-item">LMS ITH</a></li>
                                <li class="nav-item"><a href="http://cintasatudata.ith.ac.id" class="dropdown-item">CINTA Satu Data</a></li>
                                <li class="nav-item"><a href="http://siakad.ith.ac.id" class="dropdown-item">SIAKAD</a></li>
                                <li class="nav-item"><a href="http://sister.kemdikbud.go.id" class="dropdown-item">SISTER</a></li>
                            </div>
                        </nav>
                    </div>
                @endisset
                        ...
                        @foreach ($navbarmenu->whereIn('format', [0, 1])->where('view', '1')->sortBy('order') as $loop1)
                            @if ($loop1->format == 1)
                                <li>
                                    ...
                                    <div class="collapse container isi-konten navbar-collapse align-items-start" style="top: 15.75rem; left: 50vw; position: fixed; animation: none !important; background-color: white;"
                                        id={{ "btn$loop1->id" }}>
