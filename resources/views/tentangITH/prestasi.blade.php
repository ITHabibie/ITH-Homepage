    ...
    <main class="main-table d-flex" style="gap:2rem;">
        <div class="container">
            <div class="row">
              <div class="col-md-3 ms-0 me-5 mb-4">
                <div class="" style="width: 254px; height: 255px;">
                    <img src="{{ asset('assets/img/prestasi/Gambar WhatsApp 2024-06-16 pukul 09.17.27_a2c3fba2 1 (2).png')}}" class="card-img-top" alt="...">
              ...
              <div class="col-md-3 me-5 ms-2 mb-4">
                <div class="" style="width: 254px; height: 255px;">
                    <img src="{{ asset('assets/img/prestasi/Gambar WhatsApp 2024-06-16 pukul 23.32.01_c37a629d 1 (1).png') }}" class="card-img-top" alt="...">
                    <div class="card-body text-start p-0">
              ...
              <div class="col-md-3 me-5 ms-2 mb-4">
                <div class="" style="width: 254px; height: 255px;">
                    <img src="{{ asset('assets/img/prestasi/Gambar WhatsApp 2024-06-16 pukul 09.17.33_326f0ad9 1 (1).png') }}" class="card-img-top" alt="...">
                    <div class="card-body text-start p-0">
            ...
            <div class="row">
              <div class="col-md-3 me-5 ms-2 mb-4">
                <div class="" style="width: 254px; height: 255px;">
                    <img src="{{ asset('assets/img/prestasi/Gambar WhatsApp 2024-06-16 pukul 23.33.00_d506b02e 1 (1).png') }}" class="card-img-top" alt="...">
                    <div class="card-body text-start p-0">
              ...
              <div class="col-md-3 me-5 ms-2 mb-4">
                <div class="" style="width: 254px; height: 255px;">
                    <img src="{{ asset('assets/img/prestasi/Gambar WhatsApp 2024-06-16 pukul 23.36.29_f42f2c46 1 (1).png') }}" class="card-img-top" alt="...">
                    <div class="card-body text-start p-0">
