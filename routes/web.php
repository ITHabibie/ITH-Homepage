...
Route::get('/Kehidupan-kampus/perpustakaan', [App\Http\Controllers\FrontController::class, 'perpustakaan'])->name('perpustakaan');
// Penelitian
Route::get('/Penelitian/pkm', [App\Http\Controllers\FrontController::class, 'pkm'])->name('pkm');
// Admin Panel
